...
"[project]/app/dashboard/ppi/LeaderboardRuangan.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LeaderboardRuangan({ data }) {
    // 1. Hitung total HAIs per ruangan
    const stats = data.reduce((acc, curr)=>{
        const ruangan = curr.master_ruangan?.nama_ruangan || "Tanpa Nama";
        const totalHais = (curr.isk || 0) + (curr.iad || 0) + (curr.vap || 0) + (curr.hap || 0);
        if (!acc[ruangan]) {
            acc[ruangan] = 0;
        }
    ...
    // 2. Ubah ke Array dan urutkan dari yang terbesar
    const sortedStats = Object.entries(stats).map(([name, total])=>({
            name,
            total
        })).sort((a, b)=>b.total - a.total).slice(0, 5); // Ambil 5 teratas
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "bg-white rounded-[2rem] border border-slate-100 p-6 shadow-sm font-sans h-full",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-4",
                children: sortedStats.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-[10px] text-slate-400 italic font-bold uppercase py-4 text-center",
                    children: "Belum ada temuan kasus HAIs."
                }, void 0, false, {
                    fileName: "[project]/app/dashboard/ppi/LeaderboardRuangan.tsx",
                    lineNumber: 42,
                    columnNumber: 11
                }, this) : sortedStats.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center gap-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-6 h-6 rounded-lg bg-slate-50 flex items-center justify-center text-[10px] font-black text-slate-400",
                                children: [
                                    "#",
                                    idx + 1
                                ]
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            style: {
                                                width: `${item.total / (sortedStats[0].total || 1) * 100}%`,
                                                opacity: 1 - idx * 0.15 // Efek gradasi warna
                                            }
                                        }, void 0, false, {
                                            fileName: "[project]/app/dashboard/ppi/LeaderboardRuangan.tsx",
                                            lineNumber: 65,
            ...
            sortedStats.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-6 pt-4 border-t border-slate-50",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex items-center gap-2 text-amber-600 bg-amber-50 p-2.5 rounded-xl border border-amber-100",
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-[9px] font-bold leading-tight uppercase tracking-tight",
                            children: [
                                "Ruangan ",
                                sortedStats[0].name,
                                " membutuhkan audit segera."
                            ]
                        }, void 0, true, {
                            fileName: "[project]/app/dashboard/ppi/LeaderboardRuangan.tsx",
                            lineNumber: 83,
...
_c = LeaderboardRuangan;
var _c;
__turbopack_context__.k.register(_c, "LeaderboardRuangan");
...
//# sourceMappingURL=_00ed4a67._.js.map