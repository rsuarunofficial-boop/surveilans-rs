module.exports = [
"[project]/services/data:fc17ac [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$fc17ac__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/services/data:fc17ac [app-ssr] (ecmascript) <text/javascript>");
...
function TabelVerifikasi({ data = [] }) {
    ...
    const handleVerify = async ()=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$fc17ac__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["verifySurveilansBatch"])(selectedIds);
            if (res.success) {
                setSelectedIds([]);
                router.refresh();
...
//# sourceMappingURL=_7dbc97d9._.js.map